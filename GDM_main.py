...
from runners_ddp_nl.diffusion import Diffusion
    ...
    if not args.test and not args.sample:
        ...
        if args.sample:
            ...
            if args.fid:
                ...
                args.exp, "image_samples", args.doc, "visual_results")
    ...
    try:
        ...
        if args.sample:
            if args.dataset=='PMUB':
                runner.sr_sample()
            elif args.dataset=='LDFDCT':
                runner.sg_sample()
            else:
                raise Exception("This script only supports LDFDCT and PMUB as sampling dataset. Feel free to add your own.")
        elif args.test:
            runner.test()
        else:
            if args.dataset=='PMUB':
                ...
                raise Exception("This script only supports LDFDCT and PMUB as training dataset. Feel free to add your own.")
    except Exception:
